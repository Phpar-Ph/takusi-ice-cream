...
function About() {
  return (
    <div className="h-full w-full relative bg-secondary pt-40 pb-40" id="about">
      <div className="container ">
        <div className=" md:relative  md:border-2 rounded-2xl">
          <div className=" rounded-2xl  border-2 md:border-none md:pt-6  mt-4 p-4 mb-4 md:static pb-10 md:flex md:flex-row-reverse gap-4">
            ...
            <div className="md:w-[40%] lg:borde-2  z-1 md:mt-4 md:ml-0 md:mb-4 md:mr-0  md:p-6 ">
              <h2 className="text-2xl  lg:text-4xl font-bold mb-8 text-center font-montserrat text-bluePrimary">
                Our Story
              </h2>
              <p className="text-lg md:text-sm lg:text-3xl indent-16  leading-normal font-montserrat font-medium text-bluePrimary">
